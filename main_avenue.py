...
parser.add_argument('--score_smoothing', type=float, default=20.0,
...
parser.add_argument('--score_patch_size', type=int, default=32,
...
parser.add_argument('--h', type=int, default=192, help='height of input images')
parser.add_argument('--w', type=int, default=192, help='width of input images')
parser.add_argument('--learning_rate_avenue', default=0.00001, type=float,
                    help='initial learning rate for the lightweight Avenue model')
...
parser.add_argument('--exp_dir', type=str, default='avenue_res192_01', help='basename of folder to save weights')
